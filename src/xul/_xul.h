...
XUL_APIEXPORT void xul_verbose_filter_default(const gchar *, xul_verbose_mask_e, const gchar *, gpointer);
XUL_APIEXPORT void xul_verbose_filter_time0(const gchar *, xul_verbose_mask_e, const gchar *, gpointer);
XUL_APIEXPORT void xul_verbose_filter_iso8601(const gchar *, xul_verbose_mask_e, const gchar *, gpointer);
